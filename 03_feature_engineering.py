...
class FeatureEngineer:
    ...
    def create_features(self, df):
        ...
        features['weight_category'] = pd.cut(features['parcel_weight_kg'], 
                                              bins=[0, 2, 5, 10, 20], 
    ...
    def run(self):
        ...
        print(f"Features created! {len(ml_df)} records, {len(ml_df.columns)} features")
        print(f"Saved to {self.features_path}/")
